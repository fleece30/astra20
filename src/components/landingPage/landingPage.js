...
const str =
  '<a href="https://astra2020.hackerearth.com/" target="_blank" rel="noopener noreferrer">Hackerearth</a>';
...
const judges = [
  ...
  },
  {
    ...
    desig:
      "SEDS USA Alumni, Project Manager and New Space Research and Technologies",
  },
];
...
const questions = [
  {
    ...
    ans:
      "Students from all engineering subdivisions and colleges are welcome to participate in Astra 2020.",
  },
  {
    id: "2",
    ques: "How much is the participation fee?",
    ans:
      "Teams can submit their abstracts and register for free. A nominal fee of Rs. 100 is to be paid to attend the final stage of the hack in VIT, Vellore which includes refreshments.",
  },
  {
    id: "3",
    ...
    ans:
      "You can visit " +
      str +
      " to register for Astra 2020 irrespective of your college or country of origin.",
  },
  {
    id: "4",
    ques: "Is it a purely coding-based hackathon?",
    ans:
      "No. The problem statements are designed such that there's something for all backgrounds and we encourage multi-disciplinary team formation.",
  },
  {
    id: "5",
  ...
  },
  {
    ...
    ans:
      "The total prize money is Rs. 60000 for the top three positions along with certificates and merchandise.",
  },
  {
    id: "7",
    ques: "How to reach Vellore?",
    ans:
      "The nearest airports are Chennai and Bangalore while buses and trains ply regularly from all nearby junctions.",
  },
  {
    id: "8",
    ques: "What if I don't have a team?",
    ans:
      "Worry not. You can register on " +
      str +
      " and we'll do the team formation as suitable.",
  },
  {
    id: "9",
    ques:
      "I am not very interested in/aware of the developments in the space sector. Should I participate?",
    ans:
      "Absolutely. Astra is first and foremost a platform to show and grow your engineering skills. Webinars from industry experts and our panel of judges would be more than enough to help you apply your knowledge in the space sector.",
  },
  {
    id: "10",
    ques: "Whom do I contact for more information?",
    ans:
      "You can contact us on Facebook or Instagram or mail us at <a href='mailto:vit.sedsindia@gmail.com'>vit.sedsindia@gmail.com</a>.",
  },
  {
    id: "11",
    ques: "Will we be provided with food and the internet?",
    ans:
      "Yes, refreshments would be provided at regular intervals along with lunch and dinner. VIT wifi would also be provided.",
  },
];
...
const LandingPage = () => {
      ...
      <div className="tracksGrid">
        ...
        <Fade bottom>
          <div className="comingSoon">
            ...
            <a
              href={process.env.PUBLIC_URL + "/ASTRA_PS.pdf"}
              download
            ...
            >
              ...
              <button
                ...
                name="button"
                target="_blank"
                style={{ padding: "15px", width: "200px", outline: "none" }}
              >
                Download
              </button>
            </a>
  ...
  const hackImagesCarousel = (images) => {
    return images.map((img, key) => (
      <div key={key}>
        <img
          src={process.env.PUBLIC_URL + "/images/" + img.img + ".jpg"}
          alt=""
        />
      </div>
    ));
  ...
  const winnerImagesCarousel = (winners) => {
    return winners.map((winner, key) => (
      <div key={key}>
        <img
          src={process.env.PUBLIC_URL + "/images/" + winner.img + ".jpg"}
          alt=""
        />
        <p className="legend">
          <b style={{ letterSpacing: "3px" }}>{winner.name}</b>
          <br />
          {winner.pos}
        </p>
      </div>
  ...
  const judgeCards = (judges) => {
    return judges.map((judge, key) => (
      <aside key={key} className="profile-card">
        <header>
          <img
            src={process.env.PUBLIC_URL + "/images/" + judge.img}
            alt=""
          ></img>
          <h1>{judge.name}</h1>
        </header>
      ...
      <div className="faq-content" style={{ fontFamily: "Montserrat" }}>
        {questions.map((question, key) => (
          <div key={key} className="faq-question">
            ...
            <label htmlFor={question.id} className="panel-title">
              {question.ques}
            </label>
    ...
    <div>
      ...
      <div id="home">
        ...
        <div className="content">
          <img
            src="http://sedsindia.org/astra19/images/astranegativelogoFINAL.png"
            alt=""
          ></img>
          <h3>
            Sustainable and Smart Solutions to
            <br /> New Age Space Problems
          </h3>
          <h4>
            28<sup>th</sup> and 29<sup>th</sup> March <sup>'</sup>20
          </h4>
          <h4>VIT, Vellore</h4>
          <a href="https://astra2020.hackerearth.com/">
            {" "}
            <button
              type="button"
              className="btn-grad"
        ...
        <p className="scroll-down">
          <a href="#aboutseds" className="animate">
            {" "}
          </a>
        </p>
      </div>
      ...
      <div className="grid-container" id="aboutseds">
        ...
        <div className="about">
          <div className="headings">
            <div>
              <div className="heading intro">
                <span id="heading" style={{ fontSize: "60px" }}>
                  What is ASTRA?
                </span>
              </div>
            </div>
          ...
          <div style={{ marginTop: "20px!important" }}>
            Citing the importance of developing not just smart but sustainable
            solutions to new age problems, we bring the second edition of our
            space-themed hackathon, ASTRA 2020. Team selections will be done
            upon the basis of abstracts of solutions to the given real-world
            problem statements and letters of intent. In the 24-hours hack, the
            progress made by the teams based upon their original abstracts in
            the first 10 hours will decide their entry into the next round. Here
            they will be given real-time challenges like budget cuts, module
            failure etc. and teams will be evaluated based upon their solutions
            to these problems. In the final round, the qualified teams will have
            to present their entire design and solutions in a short presentation
            to a panel of experts. Based upon the views of the experts and
            scores from previous rounds, the winner will be decided. We aim to
            provide the winners technical support to further develop their ideas
            and prototypes by partnering with suitable organisations.
          </div>
          <div>
            <Fade right>
              <Countdown
                timeTillDate="03 28 2020, 9:00 am"
      ...
      >
        ...
        <Fade left>
          <h3 className="highlight-heads">The Hack</h3>
        </Fade>
        <Fade right>
          <Carousel
            className="carousel-hack"
            width={mobile ? "90%" : "70%"}
            showThumbs={false}
            autoPlay={true}
          >
        ...
        <Fade left>
          <h3 className="highlight-heads">The Winners</h3>
        </Fade>
        <Fade right>
          <Carousel
        ...
        <div className="judge-grid">{judgeCards(judges)}</div>
        ...
        <div className="sponsor-grid">
          <div style={{ display: "table-cell", verticalAlign: "middle" }}>
            <img
              src={process.env.PUBLIC_URL + "/images/voyager.png"}
              alt=""
            ></img>
          </div>
          <div style={{ display: "table-cell", verticalAlign: "middle" }}>
            <img
              src={process.env.PUBLIC_URL + "/images/nitrexo.png"}
              alt=""
            ></img>
          </div>
          <div style={{ display: "table-cell", verticalAlign: "middle" }}>
            <img
              src={process.env.PUBLIC_URL + "/images/murmur.png"}
              alt=""
            ></img>
          </div>
        </div>
        <Carousel className="carousel-sponsor" showThumbs={false}>
          <div
            style={{ display: "table-cell", position: "relative", top: "50px" }}
          >
            <img
              src={process.env.PUBLIC_URL + "/images/voyager.png"}
              alt=""
          ...
          <div
            style={{ display: "table-cell", position: "relative", top: "80px" }}
          >
            <img
              src={process.env.PUBLIC_URL + "/images/nitrexo.png"}
              alt=""
        ...
        <div className="contact-grid">
          ...
          >
            ...
            <h2>
              Email us at{" "}
              <a
                href="mailto:vit.sedsindia@gmail.com"
                style={{ color: "#fd79a8", textDecoration: "none" }}
              >
                vit.sedsindia@gmail.com
              </a>
            </h2>
            <div style={{ fontSize: "40px" }}>OR, you know..</div>
            <h2>
              The telephone is a good way to talk to people without having to
              offer them a drink. <br />
              So, Ring us up @
            </h2>
            <h2>
              <a
                href="tel:+919003387780"
                style={{ color: "#fd79a8", textDecoration: "none" }}
              >
                +91-9003387780
              </a>{" "}
              - Aditya Bhartia (Chair - SEDS VIT)
            </h2>
            <h2>
              <a
                href="tel:+918291142445"
                style={{ color: "#fd79a8", textDecoration: "none" }}
              >
                +91-8291142445
              </a>{" "}
              - Ghanishtha Bhatti (Director of Events - SEDS VIT)
            </h2>
            <div className="social_icons">
              <div>
                <a
                  href="https://www.facebook.com/SEDSVIT/?ref=br_rs"
                  target="_blank"
              ...
              <div>
                <a
                  href="https://www.instagram.com/sedsvit/?hl=en"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <img
              ...
              <div>
                <a
                  href="https://www.linkedin.com/company/students-for-exploration-and-development-of-space/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <img
      ...
      <div id="footer">
        ...
        ,{" "}
        <a
          href="https://www.linkedin.com/in/prakhar-mehta-983494180/"
          rel="noopener noreferrer"
          target="_blank"
        >
          Prakhar
        ...
        and{" "}
        <a
          href="https://www.linkedin.com/in/shubham-aniket-5766b5178/"
          rel="noopener noreferrer"
          target="_blank"
        >
          Shubham
